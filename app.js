        ...
        const res = await fetch(baseUrl, {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: 'system',
                        content: `คุณคือผู้ช่วย AI อัจฉริยะ ปัจจุบันคุณกำลังถูกรันคำสั่งภายใต้ชื่อโมเดลว่า "${MODELS.find(m => m.id === selectedModel)?.name || selectedModel}" หากผู้ใช้ถามว่าคุณคือใครให้ตอบตามชื่อนี้ ห้ามตอบรุ่นอื่นเด็ดขาด ตอบเป็นภาษาไทยอย่างเป็นธรรมชาติ\n\n**สำคัญมาก**: หากต้องใช้สูตรคณิตศาสตร์ คุณ "ต้อง" ขึ้นบรรทัดใหม่ก่อนและหลังสูตรเสมอ และใช้ $$ ครอบสูตรเท่านั้น เช่น:\nนี่คือสูตรครับ\n$$\nA = \\pi r^2\n$$`
                    },
